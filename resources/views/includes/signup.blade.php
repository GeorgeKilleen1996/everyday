          ...
          <div class="row justify-content-center">
            <div class="col-md-12">
              <div class="form-block">
                  <div class="mb-4">
                  <h3>Sign Up for <strong>EveryDay</strong></h3>
                  <p class="mb-4">Please fill out the form below with your details and click the 'Register' button to sign up for an account with EveryDay.</p>
                </div>
